...
function Header() {
    return (
        ...
        >
            <p>
                Welcome to chord identification. When you press play, you will
                be given a series of random chords. Identify them using the drop
                down box.
            </p>
            <p
        ...
        slide-in-from-top ease-in-out duration-700 mt-[1.5%]"
            >
                The possible chords are: Major, Minor. Dominant 7th, Diminished
                7th, Major 7th, Minor 7th, and Augmented Triad.
                <br />
                Major and Minor may be in root position or first inversion. All
                other chords will be in root position.
                <br />
            ...
            return (
                <div>
                    <h2 className="text-4xl my-[1.5%] font-normal mx-[4%]">
                        Chords Remaining: {roundsPerGame - playsCompleted}
                    </h2>
